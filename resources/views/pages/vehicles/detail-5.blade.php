                            ...
                            <div class="stm-car-carousels">
                                ...
                                <div class="stm-big-car-gallery owl-carousel owl-loaded owl-drag">
                                    <div class="owl-stage-outer">
                                       ...
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 768w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 350w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 600w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 500w,
...
{{--                                            </div>--}}
                                ...
                                <div class="stm-thumbs-car-gallery owl-carousel owl-loaded owl-drag">
                                    <div class="owl-stage-outer">
                                       ...
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 300w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 768w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 795w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 600w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 500w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 700w,
                                       {{asset ('Thumbnails/TN - K5.jpg')}} 796w" sizes="(max-width: 350px) 100vw, 350px">
                                            ...
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1210">
                                                    <img src="{{asset ('Rental Cars Pictures/Kia k5/16-9/2023-kia-K5_6.jpg')}}" alt="2023 KIA PICANTO full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                            ...
                                            <div class="wpb_wrapper">
                                                <div class="lists-inline">
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Driver and Front Passenger Airbags </span></li>
                                                        <li><span style="color: #232628;">Anti Lock Braking System (ABS) </span></li>

                                                        <li><span style="color: #232628;">Tinted Glass</span></li>
                                                        <li><span style="color: #232628;">LED Head Lamps </span></li>
                                                        <li><span style="color: #232628;">Auto Light Control</span></li>
                                                        <li><span style="color: #232628;">Electric Folding Mirrors</span></li>
                                                        <li><span style="color: #232628;">Keyless Entry System</span></li>
                                                        <li><span style="color: #232628;">Dual Exhaust Muffler</span></li>
                                                        <li><span style="color: #232628;">Full Size Alloy Spare Wheel</span></li>

                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">LED Daytime Running Lights (D.R.L) </span></li>
                                                        <li><span style="color: #232628;">LED Front Fog Lamps</span></li>
                                                        <li><span style="color: #232628;">LED Rear Fog Lamp</span></li>
                                                        <li><span style="color: #232628;">LED Rear Combination Lamp </span></li>
                                                        <li><span style="color: #232628;">Tilt & Telescopic Steering </span></li>
                                                        <li><span style="color: #232628;">Radio with USB</span></li>
                                                        <li><span style="color: #232628;">Audio Remote Control</span></li>
                                                        <li><span style="color: #232628;">Leather AT Knob </span></li>
                                                        <li><span style="color: #232628;">Rear View Camera</span></li>

                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Bluetooth with Voice Recognition </span></li>
                                                        <li><span style="color: #232628;">Auto Cruise Control</span></li>
                                                        <li><span style="color: #232628;">Driver's Seat Height adjuster </span></li>
                                                        <li><span style="color: #232628;">Power Windows</span></li>
                                                        <li><span style="color: #232628;">Electronic Stability Program (ESP)</span></li>
                                                        <li><span style="color: #232628;">Tyre pressure Monitoring System (TPMS)</span></li>
                                                        <li><span style="color: #232628;">8" Audio Display</span></li>
                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Engine immobilizer </span></li>
                                                        <li><span style="color: #232628;">Trip Computer</span></li>
                                                        <li><span style="color: #232628;">Hood Insulator </span></li>
                                                        <li><span style="color: #232628;">Drive Mode Select</span></li>
                                                        <li><span style="color: #232628;">Rear AC Vent</span></li>
                                                        <li><span style="color: #232628;">Child Anchor (ISO FIX)</span></li>
                                                        <li><span style="color: #232628;">Front and Rear Parking Assist System </span></li>
                                                        <li><span style="color: #232628;">17" Alloy Wheel</span></li>
                                                        <li><span style="color: #232628;">Android Auto & Car Play</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                                                        </div>--}}
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="t-value h6">2.0l MPI</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Engine Type  </td>
                                                                                <td class="t-value h6"> DOHC,Dual CVVT Engine,4 Cylinder Euro 4 </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Power (ps / rpm)</td>
                                                                                <td class="t-value h6">150/6200</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Torque (kg.m / rpm)</td>
                                                                                <td class="t-value h6"> 19.6 / 4000</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Transmission</td>
                                                                                <td class="t-value h6">  6 Speed AT</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Front suspension</td>
                                                                                <td class="t-value h6"> McPherson strut & stabilizer</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Rear suspension</td>
                                                                                <td class="t-value h6"> multi-link </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Power steering system</td>
                                                                                <td class="t-value h6">MDPS</td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </div>-->
