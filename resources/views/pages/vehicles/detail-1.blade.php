                                    ...
                                    <div class="owl-stage-outer">
                                       ...
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 796w" sizes="(max-width: 350px) 100vw, 350px">
                                            ...
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image " data-id="big-image-1204">
                                                    <a class="fancy-iframe" data-iframe="true" data-src="">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09 copy.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1205">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_1 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1206">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_2 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1207">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_3 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1208">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_4 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1209">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_5 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1210">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_6 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1211">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_7 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1212">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_8 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1213">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_9 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1214">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_10 copy.jpg')}}" alt="2016 Mercedes-Benz C-Class C300 4MATIC full">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="wpb_tabs wpb_content_element" data-interval="0">
                                <div class="wpb_wrapper wpb_tour_tabs_wrapper ui-tabs stm_tabs_style_1 vc_clearfix ui-corner-all ui-widget ui-widget-content">
                                    <ul class="wpb_tabs_nav ui-tabs-nav vc_clearfix ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header" role="tablist">
                                        <li role="tab" tabindex="0" class="ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active" aria-controls="tab-90676444-d4f2-8" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true"><a href="#tab-90676444-d4f2-8" tabindex="-1" class="ui-tabs-anchor" id="ui-id-1">Vehicle Features</a></li>
                                    </ul>
                                            ...
                                            <div class="wpb_wrapper">
                                                <div class="lists-inline">
                                                    <ul class="" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Front engine/Front-Wheel Drive (FWD)</span></li>
                                                        <li><span style="color: #232628;">Xtronic CVT (Continuously Variable Transmission)</span></li>
                                                        <li><span style="color: #232628;">Vented front disc/rear drum brakes</span></li>
                                                        <li><span style="color: #232628;">4-wheel Anti-lock Braking System (ABS)</span></li>
                                                        <li><span style="color: #232628;">Electronic Brake force Distribution (EBD)</span></li>
                                                    </ul>
                                                    <ul class="" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Brake Assist</span></li>
                                                    ...
                                                    <ul class="" style="font-size: 13px;">
                                                        ...
                                                        <li><span style="color: #232628;">Hill start assist</span></li>
                                                    ...
                                                    <ul class="" style="font-size: 13px;">
                                                        ...
                                                        <li><span style="color: #232628;">LED fog lights</span></li>
                                                    ...
                                                    <div class="vin_report_section" style="margin-left:12px; width:230px;">
                                                        <div class="single-car-mpg">
                                                            ...
                                                            <button class="report_button stm-button heading-font" data-vin="WDDGJ5HB1CF792XXX	">
                                                                180 AED Daily	</br></br>1080 AED Weekly	</br></br>3600 AED Monthly	</br></br>	39,600 AED Yearly	</button>
                                                                ...
                                                                <div class="wpb_wrapper">
                                                                    ...
                                                                    <div class="single-car-data">
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <tr>
                                                                                <td class="t-label">DOHC  </td>
                                                                                <td class="t-value h6">16-valve 4-cylinder</td>
                                                                            </tr>
                                                                            <tr>
