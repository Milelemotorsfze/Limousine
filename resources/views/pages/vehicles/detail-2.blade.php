                                        ...
                                        <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 5586px;">
                                            <div class="owl-item active" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-495">
                                                    <a href="{{asset ('Thumbnails/TN - KICKS.jpg')}}"
                                            ...
                                            <!-- <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image " data-id="big-image-1204">
                                                    <a class="fancy-iframe" data-iframe="true" data-src="">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09 copy.jpg')}}" class="img-responsive"
                                                             alt="">
                                                    </a>
                                                </div>
                                            </div> -->
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1204">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09 copy.jpg')}}" class="stm_fancybox external"
                                                       rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09 copy.jpg')}}"
                                            ...
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1205">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_1 copy.jpg')}}" class="stm_fancybox external"
                                                       rel="stm-car-gallery nofollow">
                                            ...
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1206">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_2 copy.jpg')}}" class="stm_fancybox external"
                                                       rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_2 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1207">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_3 copy.jpg')}}" class="stm_fancybox external"
                                                       rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_3 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1208">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_4 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_4 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1209">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_5 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_5 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1210">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_6 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_6 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1211">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_7 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_7 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1212">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_8 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_8 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1213">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_9 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_9 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 798px;">
                                                <div class="stm-single-image" data-id="big-image-1214">
                                                    <a href="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_10 copy.jpg')}}"
                                                       class="stm_fancybox external" rel="stm-car-gallery nofollow">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_10 copy.jpg')}}"
                                                             alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1148px;">
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-495">
                                                    <img width="350" height="205" src="{{asset ('Thumbnails/TN - KICKS.jpg')}}"
                                                         class="img-responsive wp-post-image" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK" decoding="async" loading="lazy"
                                                         srcset="{{asset ('Thumbnails/TN - KICKS.jpg')}} 350w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 150w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 300w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 768w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 795w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 600w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 500w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 700w,
                                       {{asset ('Thumbnails/TN - KICKS.jpg')}} 796w" sizes="(max-width: 350px) 100vw, 350px">
                                                </div>
                                            </div>
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image " data-id="big-image-1204">
                                                    <a class="fancy-iframe" data-iframe="true" data-src="">
                                                        <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                            ...
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1206">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_2 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item active" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1207">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_3 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1208">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_4 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1209">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_5 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1210">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_6 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1211">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_7 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1212">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_8 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1213">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_9 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 142px; margin-right: 22px;">
                                                <div class="stm-single-image" id="big-image-1214">
                                                    <img src="{{asset ('Rental Cars Pictures/Nissan Kicks/16-9/Nissan licks21-09_10 copy.jpg')}}" alt="(LHD) NISSAN KICKS 1.6P AT MY2022 - BLACK">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab-90676444-d4f2-8" class="wpb_tab ui-tabs-panel wpb_ui-tabs-hide vc_clearfix ui-corner-bottom ui-widget-content" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="false" style="display: block;">
                                        <!-- <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <p>Vented front disc/rear drum brakes</p>
                                                <p>4-wheel Anti-lock Braking System (ABS)</p>
                                            ...
                                            <div class="wpb_wrapper">
                                                <div class="lists-inline">
                                                    <ul class="list-style-2"  style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Electric power steering</span></li>

                                                    </ul>
                                                    <ul class="list-style-2"  style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Torsion beam rear axle</span></li>

                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
{{--                                                        <li><span style="color: #232628;"></span></li>--}}
                                                        <li><span style="color: #232628;">Front stabilizer bar</span></li>
                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Independent strut front suspension</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div> -->
                                        <!-- <h4 class="mb-3">DRIVER ASSISTANCE TECHNOLOGIES</h4> -->
                                            <!-- <div class="lists-inline">
                                                ...
                                                <ul  style="font-size: 13px;">
                                                    <li ><span style="color: #232628;">Rear-view Monitor</span></li>
                                                </ul>
                                                <ul  style="font-size: 13px;">
                                                    <li ><span style="color: #232628;">Integrated Dynamics-control Module</span></li>
                                                </ul>
                                                <ul style="font-size: 13px;">
                                        ...
                                        <!-- <h4 class="mb-3">EXTRA FEATURES</h4> -->
                                            <!-- <div class="lists-inline">
                                                ...
                                                <ul class="" style="font-size: 13px;">
                                                    <li><span style="color: #232628;">Body-colour outside door handles</span></li>
                                                    <li><span style="color: #232628;">Power outside mirrors</span></li>

                                                </ul>
                                                <ul class="" style="font-size: 13px;">
                                                    <li><span style="color: #232628;">Rear bumper body-colour inserts</span></li>
                                                    <li><span style="color: #232628;">Silver exterior door trim</span></li>
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <div class="lists-inline">
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Manual Air conditioning</span></li>
                                                        <li><span style="color: #232628;">Power windows with driver & front-passenger</span></li>
                                                        <li><span style="color: #232628;">Power door locks with auto-locking feature</span></li>
                                                        <li><span style="color: #232628;">Tilt and telescoping steering column</span></li>
                                                        <li><span style="color: #232628;">Chrome interior door handles</span></li>
                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Variable intermittent windshield wipers</span></li>
                                                        <li><span style="color: #232628;">Intermittent rear window wiper</span></li>
                                                        <li><span style="color: #232628;">12-volt DC power outlet</span></li>
                                                        <li><span style="color: #232628;">Sun visors with vanity mirrors and extensions</span></li>
                                                        <li><span style="color: #232628;">Cloth seat trim</span></li>
                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Overhead map lights</span></li>
                                                        <li><span style="color: #232628;">Front driver and passenger seatback pocket</span></li>
                                                        <li><span style="color: #232628;">Four cup holders</span></li>
                                                        <li><span style="color: #232628;">Four bottle holders</span></li>
                                                        <li><span style="color: #232628;">Four cargo tie-down hooks</span></li>
                                                    </ul>
                                                    <ul class="list-style-2" style="font-size: 13px;">
                                                        <li><span style="color: #232628;">Seating/Appointments</span></li>
                                                        <li><span style="color: #232628;">6-way manual driver’s seat</span></li>
                                                        <li><span style="color: #232628;">4-way manual front-passenger’s seat</span></li>
                                                        <li><span style="color: #232628;">Driver’s seat armrest</span></li>
                                                        <li><span style="color: #232628;">60/40 2nd-row split-folding seat</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
{{--                                    <div id="tab-745aa3c6-a316-2" class="wpb_tab ui-tabs-panel wpb_ui-tabs-hide vc_clearfix ui-corner-bottom ui-widget-content"--}}
...
{{--                                                        <input type="text" class="numbersOnly vehicle_price" value="35000">--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="col-md-3 col-sm-6 stm_changeable_breakpoint">--}}
{{--                                                    <!--Interest rate-->--}}
...
{{--                                                            <div class="monthly_payment h5">1418.38</div>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="result">--}}
{{--                                                            <div class="stm-calc-label">Total Interest Payment</div>--}}
{{--                                                            <div class="total_interest_payment h5">1041.12</div>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="result">--}}
{{--                                                            <div class="stm-calc-label">Total Amount to Pay</div>--}}
{{--                                                            <div class="total_amount_to_pay h5">36041.12</div>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
<!--<h5>Performance</h5>
                                                                        <table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="t-value h6">DOHC, 16-valve 4-cylinder</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Transmission</td>
                                                                                <td class="t-value h6">Xtronic CVT (Continuously Variable Transmission)
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Power (ps / rpm)</td>
                                                                                <td class="t-value h6">118/6300</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="t-label">Torque (lb-ft / rpm)</td>
                                                                                <td class="t-value h6">114 / 4000</td>
                                                                            </tr>
