         ...
         <div class="clearfix">
            ...
            <div class="mobile-menu-holder">
               <ul class="header-menu clearfix">
                  ...
                  --}}
                  {{--							
                  <li id="menu-item-3084" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3084">
                     <a href="#">Pages</a>--}}
                     {{--							
                     <ul class="sub-menu">
                        --}}
                  ...
                  --}}
                  {{--							
                  <li id="menu-item-3086" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3086 stm_megamenu stm_megamenu__boxed">
                     <a href="#">Mega Menu</a>--}}
                     {{--							
                     <ul class="sub-menu">
                        --}}
                        {{--								
                        <li id="menu-item-3087" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3087">
                           <div class="menu-title heading-font">Special Offers</div>
                           <div class="stm-special-offers">
                              <div class="special-wrap">
                                 <div class="img-wrap"><a href="listings/lamborghini-urus-2021/index.html"><img src="{{asset ('uploads/2021/03/01-18-120x120.jpg')}}" /></a></div>
                                 <div class="title-price-wrap">
                                    <div class="car-title"><a href="listings/lamborghini-urus-2021/index.html">Lamborghini Urus 2021 Stage 2, Akrapovic Exhaust</a></div>
                                    <div class="prices"><span class="normal_price normal_font has_sale">$340 000</span><span class="sale_price heading-font">$305 000</span></div>
                                 </div>
                              </div>
                              <div class="special-wrap">
                                 <div class="img-wrap"><a href="listings/bmw-m5/index.html"><img src="{{asset ('uploads/2021/03/01-6-120x120.jpg')}}" /></a></div>
                                 <div class="title-price-wrap">
                                    <div class="car-title"><a href="listings/bmw-m5/index.html">2021 BMW M5 F90 FULL OPTIONS</a></div>
                                    <div class="prices"><span class="normal_price normal_font has_sale">$115 000</span><span class="sale_price heading-font">$99 000</span></div>
                                 </div>
                              </div>
                           </div>
                        </li>
                        ...
                        <li id="menu-item-3088" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3088">
                           <div class="menu-title heading-font">New Vehicles</div>
                           --}}
                           {{--								
                           <ul class="sub-menu">
                              --}}
                        ...
                        --}}
                        {{--								
                        <li id="menu-item-3098" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3098">
                           <div class="menu-title heading-font">Quick Search</div>
                           --}}
                           {{--								
                           <ul class="sub-menu">
                              --}}
                        ...
                        --}}
                        {{--								
                        <li id="menu-item-3103" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3103">
                           <div class="menu-title heading-font">Contacts</div>
                           <ul class='mm-list'>
                              <li class='normal_font'><i class='fas fa-envelope'></i>info@stylemixthemes.com</li>
                              <li class='normal_font'><i class='fas fa-phone'></i>+1 628 123 4000</li>
                              <li class='normal_font'><i class='fas fa-map-marker'></i>1010 Avenue of the Moon, NY 10018 US.</li>
                              <li class='normal_font'><i class=''></i>Mon-Sat: 8:00AM-6:00PM</li>
                           </ul>
                        </li>
                        --}}
                        {{--							
                  ...
                  --}}
                  {{--							
                  <li id="menu-item-3211" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3211">
                     ...
                     <ul class="sub-menu">
                        ...
                        --}}
                        {{--								
                        <li id="menu-item-3092" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3092">
                           <a href="#">Single Post Templates</a>--}}
                           {{--								
                           <ul class="sub-menu">
                              --}}
                              {{--									
         ...
         <div class="container">
            ...
            <div class="main-menu " >
               <ul class="header-menu clearfix float-right" style="">
                  ...
                  --}}
                  {{--				
                  <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3084">
                     <a href="#">Pages</a>--}}
                     {{--				
                     <ul class="sub-menu">
                        --}}
                  ...
                  --}}
                  {{--				
                  <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3086 stm_megamenu stm_megamenu__boxed">
                     <a href="#">Mega Menu</a>--}}
                     {{--				
                     <ul class="sub-menu">
                        --}}
                        {{--					
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3087">
                           <div class="menu-title heading-font">Special Offers</div>
                           <div class="stm-special-offers">
                              <div class="special-wrap">
                                 <div class="img-wrap"><a href="listings/bmw-m5/index.html"><img src="{{asset ('uploads/2021/03/01-6-120x120.jpg')}}" /></a></div>
                        ...
                        --}}
                        {{--					
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3088">
                           <div class="menu-title heading-font">New Vehicles</div>
                           --}}
                           {{--					
                           <ul class="sub-menu">
                        ...
                        --}}
                        {{--					
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3098">
                           <div class="menu-title heading-font">Quick Search</div>
                           --}}
                           {{--					
                           <ul class="sub-menu">
                        ...
                        --}}
                        {{--					
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3103">
                           <div class="menu-title heading-font">Contacts</div>
                           <ul class='mm-list'>
                              <li class='normal_font'><i class='fas fa-envelope'></i>info@stylemixthemes.com</li>
                              <li class='normal_font'><i class='fas fa-phone'></i>+1 628 123 4000</li>
                  ...
                  --}}
                  {{--				
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3211">
                     <a href="blog/index.html">Blog</a>--}}
                     {{--				
                     <ul class="sub-menu">
                        --}}
                        ...
                        --}}
                        {{--					
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3092">
                           <a href="#">Single Post Templates</a>--}}
                           {{--					
                           <ul class="sub-menu">
                              --}}
